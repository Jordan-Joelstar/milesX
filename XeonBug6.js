...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`𝐽⃪𝑂⃪𝑅⃪𝐷⃪𝐴⃪𝑁⃪-𝐽⃪𝑂⃪𝐸⃪𝐿⃪𝑆⃪𝑇⃪𝐴⃪𝑅⃪ ${ownername} `).catch(_ => _)
        }
...
`.trim()
                await XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `JORDAN-JOELSTAR`,
                            body: `${latensi.toFixed(4)} Second`,
                            thumbnailUrl: 'https://telegra.ph/file/9f91553093f0542a6dd4c.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `🕷️`,
                            body: `𝑀⃪𝐴⃪𝐽⃪𝐼⃪𝑁⃪ 𝐽⃪𝑂⃪𝑅⃪𝐷⃪𝐴⃪𝑁⃪ 𝐽⃪𝑂⃪𝐸⃪𝐿⃪𝑆⃪𝑇⃪𝐴⃪𝑅⃪`,
                            thumbnailUrl: 'https://telegra.ph/file/9f91553093f0542a6dd4c.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
...
> _𝑀⃪𝐴⃪𝐽⃪𝐼⃪𝑁⃪ 𝐽⃪𝑂⃪𝑅⃪𝐷⃪𝐴⃪𝑁⃪-𝐽⃪𝑂⃪𝐸⃪𝐿⃪𝑆⃪𝑇⃪𝐴⃪𝑅⃪_
